...
export default function Admin({auth,user,section,subsection,status,msg,baseUrl,
    imagesPaths,page,csrf_token,users,notifications,emails,social,isApp,
    appNotificationsEnabled,biometric,shelter}){
    ...
    return (
        ...
        <Toast 
            ...
            error={toastErrorMsg}
        />
        <Header user={user} t={t} from='user' shelter={shelter}/>
        <main>
            {/*
            <h1 className="title">
                {t('user.title')}
