...
export default function Legal({t, section}){
    ...
    return (
    	<div className='home-div-box'>
            <Tabs                         
                ...
                variant="scrollable"
            >
                <Tab icon={<TermsIcon sx={sxIcon}/>} label={t('landing.terms.icon')} iconPosition="top" value="terms" sx={sx}/>
                <Tab icon={<PolicyIcon sx={sxIcon}/>} label={t('landing.policy.icon')} iconPosition="top" value="policy" sx={sx}/>                    
                <Tab icon={<CookiesIcon sx={sxIcon}/>} label={t('landing.cookies.icon')} iconPosition="top" value="cookies" sx={sx}/>                    
            </Tabs>
            <div className='subcontent-container pt-4'>            
                ...
                <div 
                    ...
                    dangerouslySetInnerHTML={{__html: t('landing.'+tab+'.content')}}
                >                
                </div>               
            </div>            
        </div>
