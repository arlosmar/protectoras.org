...
export default function Comments({t,email_colaboration,email_volunteering,prices,forms,social,guides}){
        ...
        */}
        ...
        <Grid container spacing={0} className='home-div-box'>
            ...
            <Grid size={{ xs: 12, md: 10 }}>
                ...
                <div 
                    className='paragraph-top-separation'   
                    dangerouslySetInnerHTML={{__html: t('introduction.'+shelter?.id+'.colaboration.line14',{price_partner:prices?.price_partner})}}
                >                
                </div>
                <div
                    className='paragraph-top-separation'
                    dangerouslySetInnerHTML={{__html: t('introduction.'+shelter?.id+'.colaboration.line15',{price_retired:prices?.price_retired})}}
                >                
                </div>
                <div
                    className='paragraph-top-separation'
                    dangerouslySetInnerHTML={{__html: t('introduction.'+shelter?.id+'.colaboration.line16',{price_child:prices?.price_child})}}
                >                
                </div>
                <div
                    className='paragraph-top-separation'
        ...
        <Grid container spacing={0} className='home-div-box'>
            ...
            <Grid size={{ xs: 12, md: 10 }}>
                ...
                <div 
                    className='paragraph-top-separation'   
                    dangerouslySetInnerHTML={{__html: t('introduction.'+shelter?.id+'.colaboration.line18',{price_sponsorship:prices?.price_sponsorship})}}
                >                
                </div>
                <div
                    className='paragraph-top-separation'
