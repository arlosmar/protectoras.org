...
import SanctuaryIcon from '@mui/icons-material/Foundation';

const Adopt = lazy(() => import("@/Pages/Animals/Adopt"));
const Sponsor = lazy(() => import("@/Pages/Animals/Sponsor"));
const Sanctuary = lazy(() => import("@/Pages/Animals/Sanctuary"));
const Heaven = lazy(() => import("@/Pages/Animals/Heaven"));
...
export default function Animals({user,section,subsection,emails,social,baseUrl,imagesPaths,
    ...
    const [ tabsArray , setTabsArray ] = useState(['adopt','sponsor','sanctuary','heaven']);
    const [ tabsLength , setTabsLength ] = useState(tabsArray.length);
    ...
    return (    	
        ...
        <Toast 
            ...
            message={toastMsg}
        />
    	<Header user={user} t={t} from='animals' shelter={shelter}/>
    	<main {...handlers}>
            {/*
            <h1 className="title">
    			{t('animals.title')}
            ...
            */}
            <div className='tabs-container' style={{marginTop: sticky ? height+'px': '0px'}}>
                ...
                >					
                    ...
                    <Tab icon={<SanctuaryIcon sx={sxIcon}/>} value="sanctuary" sx={sx} iconPosition="top" label={t('animals.sanctuary.icon')}/>
