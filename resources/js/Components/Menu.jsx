        ...
        >
            <Box
                sx={{
                    width: 'auto',
                    height: '100%',
                    backgroundImage:`linear-gradient(${darkmode ? "rgba(38, 38, 38, 0.92)" : "rgba(255, 255, 255, 0.92)"}, ${darkmode ? "rgba(38, 38, 38, 0.92)" : "rgba(255, 255, 255, 0.92)"}), url(${shelter?.files?.bucket && shelter?.files?.logo ? shelter.files.bucket+'/logos/'+shelter.files.logo : '/storage/protectoras.png'})`,
