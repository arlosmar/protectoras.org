...
export default function BannerInstallApp({ t, shelter }){
    ...
    return (
        <>
        {
            ...
            <PWAPrompt 
                ...
                appIconPath={shelter?.files?.bucket && shelter?.files?.logo ? shelter.files.bucket+'/logos/'+shelter.files.logo : '/storage/protectoras.png'}
            />
        }
        <Collapse 
            in={open}
