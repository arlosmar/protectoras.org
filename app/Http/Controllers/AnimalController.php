...
class AnimalController extends Controller{
    ...
    public function clearCache(){
        ...
        Cache::forget('animals_sanctuary_animals');
    }
                ...
                case 'sanctuary':
                    ...
                    if(isset($subsection) && !empty($subsection)){
                        ...
                        switch($subsection){
                            ...
                            case 'animals':
                                $animals = Cache::rememberForever('animals_sanctuary_animals', function () {
                                    return Animal::where('hidden',false)->where('dead',false)->where('status_id','3')->with('status','sponsor','type','age','gender','size','breed','person')->orderBy('name','asc')->orderBy('code','asc')->get();
                                });
                                break;                            
                        }
                    }
