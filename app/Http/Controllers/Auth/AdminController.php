...
class AdminController extends Controller
{
    ...
    public function admin(Request $request,$section = null,$subsection = null,$page = 1){
        ...
        */
        ...
        return Inertia::render('Admin/Admin',compact('user','section','subsection','status','msg','baseUrl','imagesPaths','page','csrf_token','users','notifications','emails','social','isApp','appNotificationsEnabled','biometric','shelter'));
    }
